...
function aggregatedata = aggregate(data, breakcolumns, dependentcolumn, aggfunction, suppressIdx)
...
[x, y] = consolidator(data(:,breakcolumns), data(:,dependentcolumn), aggfunction);
